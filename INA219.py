...
https://github.com/chrisb2/pyb_ina219/blob/master/ina219.py
...
class INA219:
    ...
    def __init__(self,i2c, address, shunt_ohms,   max_expected_amps=None):
        """Construct the class.
...
if __name__ == "__main__":
    i2c1 = I2C(1, scl=Pin(15), sda=Pin(14), freq=100000) #100kHz
    print(i2c1.scan())
    I2CADR = 0x40
    ...
    ina = INA219(i2c1,I2CADR ,SHUNT_OHMS )
    ina.configure()
    while True:
        print("-" * 40)
        print("V={0:.2f} V, I = {1:.2f} mA, power={2:.2f} mW".format( ina.voltage(), ina.current(), ina.power()) )
